...
function ProjectsPage() {
  // ✅ Both projects AND loadingProjects destructured from context
  ...
  // ✅ Sync projectList only after loading is done
  useEffect(() => {
    if (!loadingProjects) {
    ...
    <div className="bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 pt-20 min-h-screen">
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          {/* ✅ Projects Grid with proper loading state */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {loadingProjects ? (
              // Shows spinner while fetching — no more stuck "Loading projects..."
